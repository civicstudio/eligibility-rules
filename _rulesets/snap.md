...
ruleset:
  ...
  rules:
    - id: income-gross
      ...
      label: Gross Income
      description: "Gross monthly income must be at or below 130% of the Federal Poverty Level for your household size."
      source_url: "https://www.fns.usda.gov/snap/recipient/eligibility"
    - id: income-net
      key: household_net_income_fpl
      operator: less_than_or_equal
      value: 100
      unit: percent
      requirement: required
      label: Net Income
      description: "Net monthly income (after deductions) must be at or below 100% of the Federal Poverty Level."
      source_url: "https://www.fns.usda.gov/snap/recipient/eligibility"
    - id: assets
      ...
      requirement: required
      label: Asset Limit
      description: "Countable resources must be $2,750 or less ($4,250 if household includes elderly/disabled member)."
      source_url: "https://www.fns.usda.gov/snap/recipient/eligibility"
    - id: residency
      key: residency
      operator: equals
    ...
    - id: citizenship
      ...
      description: "Must be a U.S. citizen, U.S. national, or qualified alien."
      source_url: "https://www.fns.usda.gov/snap/eligibility/citizen/non-citizen-policy"
    - id: work-requirements
      ...
      conditions:
        - id: work-hours
          ...
          value: 20
          description: "Work at least 20 hours per week"
      any_of:
        - id: exempt-disabled
          key: has_disability
          operator: equals
